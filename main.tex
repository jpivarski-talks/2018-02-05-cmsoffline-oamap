...
\vspace{0.5 cm}
\mbox{\hspace{-0.45 cm}\textcolor{darkblue}{We can't directly use these systems in HEP without a few changes:}}

\renewcommand{\arraystretch}{1.5}

\vspace{0.5 cm}\mbox{\hspace{-0.6 cm}
\begin{tabular}{p{0.26\linewidth} p{0.2\linewidth} p{0.2\linewidth} p{0.3\linewidth}}
...
User interface & web dashboard, Google Sheets & PyROOT, rootpy, Jupyter/SWAN & {\it future} \\
\end{tabular}}
\end{frame}
